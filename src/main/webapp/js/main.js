...
function getLangDate(){
    ...
    document.getElementById("nowTime").innerHTML = "亲爱的"+document.getElementById("userName").value+timeValue+"好！ 欢迎使用layuiCMS 2.0模版。当前时间为： "+newDate+"　"+week;
...
layui.use(['form','element','layer','jquery'],function(){
    ...
    //最新文章列表
    $.get("/news/findNewsLatest",function(data){
        var hotNewsHtml = '';
        for(var i=0;i<5;i++){
            hotNewsHtml += '<tr>'
